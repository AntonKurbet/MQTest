package ru.geekbrains.mq.consumer;
...
public class BlogSubscriber {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        while(!command.equals("exit")) {
            ...
            if (command.equals("set_topic")) {
                subscribeOn(channel, queueName, EXCHANGE_NAME, s.replace("set_topic ","") + ".#");
            }
        }
        channel.close();
        connection.close();
    ...
    private static void subscribeOn(Channel channel, String queueName, String exchangeName, String topic) throws IOException {
